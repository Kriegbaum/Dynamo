...
allMap = list(range(142, 192)) + list(range(128,142)) + list(range(448, 462)) + list(range(384, 398)) + list(range(462, 512)) + list(range(398, 448)) + list(range(320, 384)) + list(range(256, 320)) + list(range(192, 256))
